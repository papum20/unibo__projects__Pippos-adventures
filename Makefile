main: alive.o animate.o animation.o artifact.o boss_room.o cell.o character.o chest.o connected_room.o coordinate.o door.o evil_tree.o fire_spirit.o snowman.o spider.o witch.o zombie.o enemy.o fire_spirit_hands.o snowman_hands.o spider_legs.o tree_branch.o witch_rod.o zombie_hands.o armor.o axe.o boots.o bow.o hands.o helm.o necklace.o player_rod.o rod.o shield.o sword.o fixed.o floor.o game_over.o hud.o inanimate.o inputmanager.o item.o item_difensivi.o health_potion.o key.o life_elixir.o rune.o level.o main.o map_handler.o math.o minimap.o overlay.o pause_menu.o physical.o pixel_art.o player.o projectile.o arrow.o fireball.o snowball.o spell.o room.o start_menu.o comparable.o priority_queue.o priority_queue_room.o queue_coordinate.o room_position.o union_find.o system_text.o timer.o wall.o weapon.o
	g++ alive.o animate.o animation.o artifact.o boss_room.o cell.o character.o chest.o connected_room.o coordinate.o door.o evil_tree.o fire_spirit.o snowman.o spider.o witch.o zombie.o enemy.o fire_spirit_hands.o snowman_hands.o spider_legs.o tree_branch.o witch_rod.o zombie_hands.o armor.o axe.o boots.o bow.o hands.o helm.o necklace.o player_rod.o rod.o shield.o sword.o fixed.o floor.o game_over.o hud.o inanimate.o inputmanager.o item.o item_difensivi.o health_potion.o key.o life_elixir.o rune.o level.o main.o map_handler.o math.o minimap.o overlay.o pause_menu.o physical.o pixel_art.o player.o projectile.o arrow.o fireball.o snowball.o spell.o room.o start_menu.o comparable.o priority_queue.o priority_queue_room.o queue_coordinate.o room_position.o union_find.o system_text.o timer.o wall.o weapon.o -lncurses -o main
...
floor.o: floor.cpp floor.hpp
	g++ -c floor.cpp
game_over.o: game_over.cpp game_over.hpp
	g++ -c game_over.cpp
...
minimap.o: minimap.cpp minimap.hpp
	g++ -c minimap.cpp
overlay.o: overlay.cpp overlay.hpp
	g++ -c overlay.cpp
...
system_text.o: system_text.cpp system_text.hpp
	g++ -c system_text.cpp
