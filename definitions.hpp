...
#define FRAMES_PER_SECOND 1					//aggiornamenti in un secondo
...
// CAMERA
#define CAMERA_WIDTH  150//300//135	//larghezza (massima) inquadratura livello
#define CAMERA_HEIGHT 50//70//35	//altezza (massima) inquadratura livello
// MINI-MAP
