...
#define COLOR_HUD_HEALTH COLOR_RED
const int COLORE_VITA = Cell (0, COLOR_BLACK, COLOR_HUD_HEALTH, 0).colorPair();
...
const int COLORE_CUORE = Cell (0, COLOR_HUD_HEALTH, COLOR_BLACK, 0).colorPair();
